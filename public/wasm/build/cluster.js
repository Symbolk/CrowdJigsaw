...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 18848,
    DYNAMIC_BASE = 5261728,
    DYNAMICTOP_PTR = 18688;
...
var wasmBinaryFile = 'cluster.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_throw": ___cxa_throw, "__lock": ___lock, "__unlock": ___unlock, "alignfault": alignfault, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "memory": wasmMemory, "round": _round, "segfault": segfault, "table": wasmTable };
var asm = createWasm();
...
var real__cluster = asm["cluster"];
asm["cluster"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__cluster.apply(null, arguments);
};
...
var _cluster = Module["_cluster"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["cluster"].apply(null, arguments)
};
